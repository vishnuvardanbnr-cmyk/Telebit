...
export default function Home() {
  ...
  return (
    <div className="container mx-auto px-4 py-6 space-y-4 max-w-2xl">
      ...
      {/* ── Investment Overview ── */}
      <Link href="/packages">
        <div className="rounded-2xl border border-border bg-white shadow-sm overflow-hidden cursor-pointer hover:shadow-md transition-shadow">
          {/* header */}
      ...
      {rankProgress && (
        <Link href="/ranks">
          <div className="rounded-2xl border border-border bg-white shadow-sm cursor-pointer hover:shadow-md transition-shadow overflow-hidden">
      ...
      {/* ── Go to Shop ── */}
      <Link href="/products">
        <div className="rounded-2xl border border-border bg-white shadow-sm cursor-pointer hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-3.5">
